...
export TMPDIR=$(pwd)
mkdir -p out
# ncu -o profile ../../../../src/gravidy-gpu -i ../../../../input/07-nbody-p131072_m1.in -o out/output -t 0.5
../../../../src/gravidy-gpu -i ../../../input/gravidy-default-input/10-nbody-p65536_m1.in -o out/output -t 0.5
